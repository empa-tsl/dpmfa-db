...
# open database
connection = sqlite3.connect(os.path.join("../../Database","DPMFA_Plastic_EU.db"))
...
stocklist = list(pd.read_csv(os.path.join("../../Database","Lifetimes_Summary.csv"),sep=";",decimal=",").columns)
